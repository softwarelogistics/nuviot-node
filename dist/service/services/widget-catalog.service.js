...
var device_chart_widget_component_1 = require("../ui/widgets/device-chart-widget/device-chart-widget.component");
var device_gauge_widget_component_1 = require("../ui/widgets/device-gauge-widget/device-gauge-widget.component");
var devices_widget_component_1 = require("../ui/widgets/devices-widget/devices-widget.component");
var device_repo_widget_component_1 = require("../ui/widgets/device-repo-widget/device-repo-widget.component");
var device_explorer_widget_component_1 = require("../ui/widgets/device-explorer-widget/device-explorer-widget.component");
var device_view_widget_component_1 = require("../ui/widgets/device-view-widget/device-view-widget.component");
var device_geo_widget_component_1 = require("../ui/widgets/device-geo-widget/device-geo-widget.component");
var device_data_widget_component_1 = require("../ui/widgets/device-data-widget/device-data-widget.component");
var device_action_widget_component_1 = require("../ui/widgets/device-action-widget/device-action-widget.component");
var device_report_widget_component_1 = require("../ui/widgets/device-report-widget/device-report-widget.component");
var date_range_picker_widget_component_1 = require("../ui/widgets/date-range-picker-widget/date-range-picker-widget.component");
var device_notes_widget_component_1 = require("../ui/widgets/device-notes-widget/device-notes-widget.component");
var device_ticket_add_widget_component_1 = require("../ui/widgets/device-ticket-add-widget/device-ticket-add-widget.component");
var device_note_add_widget_component_1 = require("../ui/widgets/device-note-add-widget/device-note-add-widget.component");
var device_tickets_widget_component_1 = require("../ui/widgets/device-tickets-widget/device-tickets-widget.component");
var device_bom_widget_component_1 = require("../ui/widgets/device-bom-widget/device-bom-widget.component");
var device_resources_widget_component_1 = require("../ui/widgets/device-resources-widget/device-resources-widget.component");
var device_connection_log_widget_component_1 = require("../ui/widgets/device-connection-log-widget/device-connection-log-widget.component");
var devices_widget_editor_component_1 = require("../uibuilder/widget-editors/devices-widget-editor/devices-widget-editor.component");
var device_action_widget_editor_component_1 = require("../uibuilder/widget-editors/device-action-widget-editor/device-action-widget-editor.component");
var device_chart_widget_editor_component_1 = require("../uibuilder/widget-editors/device-chart-widget-editor/device-chart-widget-editor.component");
var device_gauge_widget_editor_component_1 = require("../uibuilder/widget-editors/device-gauge-widget-editor/device-gauge-widget-editor.component");
var device_data_widget_editor_component_1 = require("../uibuilder/widget-editors/device-data-widget-editor/device-data-widget-editor.component");
var device_explorer_widget_editor_component_1 = require("../uibuilder/widget-editors/device-explorer-widget-editor/device-explorer-widget-editor.component");
var device_geo_widget_editor_component_1 = require("../uibuilder/widget-editors/device-geo-widget-editor/device-geo-widget-editor.component");
var device_repo_widget_editor_component_1 = require("../uibuilder/widget-editors/device-repo-widget-editor/device-repo-widget-editor.component");
var device_view_widget_editor_component_1 = require("../uibuilder/widget-editors/device-view-widget-editor/device-view-widget-editor.component");
var device_photos_widget_component_1 = require("../ui/widgets/device-photos-widget/device-photos-widget.component");
var device_notes_widget_editor_component_1 = require("../uibuilder/widget-editors/device-notes-widget-editor/device-notes-widget-editor.component");
var device_properties_widget_editor_component_1 = require("../uibuilder/widget-editors/device-properties-widget-editor/device-properties-widget-editor.component");
var device_properties_widget_component_1 = require("../ui/widgets/device-properties-widget/device-properties-widget.component");
var device_attributes_widget_editor_component_1 = require("../uibuilder/widget-editors/device-attributes-widget-editor/device-attributes-widget-editor.component");
var device_report_widget_editor_component_1 = require("../uibuilder/widget-editors/device-report-widget-editor/device-report-widget-editor.component");
var device_photos_widget_editor_component_1 = require("../uibuilder/widget-editors/device-photos-widget-editor/device-photos-widget-editor.component");
var device_attributes_widget_component_1 = require("../ui/widgets/device-attributes-widget/device-attributes-widget.component");
var date_range_picker_wdiget_editor_component_1 = require("../uibuilder/widget-editors/date-range-picker-wdiget-editor/date-range-picker-wdiget-editor.component");
var device_logs_widget_component_1 = require("../ui/widgets/device-logs-widget/device-logs-widget.component");
var device_logs_widget_editor_component_1 = require("../uibuilder/widget-editors/device-logs-widget-editor/device-logs-widget-editor.component");
var device_resources_widget_editor_component_1 = require("../uibuilder/widget-editors/device-resources-widget-editor/device-resources-widget-editor.component");
var device_bom_widget_editor_component_1 = require("../uibuilder/widget-editors/device-bom-widget-editor/device-bom-widget-editor.component");
var device_ticket_add_widget_editor_component_1 = require("../uibuilder/widget-editors/device-ticket-add-widget-editor/device-ticket-add-widget-editor.component");
var device_tickets_widget_editor_component_1 = require("../uibuilder/widget-editors/device-tickets-widget-editor/device-tickets-widget-editor.component");
var device_note_add_widget_editor_component_1 = require("../uibuilder/widget-editors/device-note-add-widget-editor/device-note-add-widget-editor.component");
var device_errors_widget_component_1 = require("../ui/widgets/device-errors-widget/device-errors-widget.component");
var device_errors_widget_editor_component_1 = require("../uibuilder/widget-editors/device-errors-widget-editor/device-errors-widget-editor.component");
// tslint:disable-next-line:max-line-length
var device_connection_log_widget_editor_component_1 = require("../uibuilder/widget-editors/device-connection-log-widget-editor/device-connection-log-widget-editor.component");
var WidgetCatalogService = /** @class */ (function () {
    function WidgetCatalogService() {
        this.catalog = [
            {
                ...
                isBeta: true,
                fields: [],
                getDefaultWidgetAttributes: function () { return { populationStrategy: { id: '-1', text: 'not specified' } }; }
            },
            {
    ...
    WidgetCatalogService.prototype.getWidget = function (widgetId) {
        var widgets = new linqts_1.List(this.catalog);
        return widgets.Where(function (wig) { return wig.widgetId === widgetId; }).FirstOrDefault();
    };
    WidgetCatalogService.prototype.getComponent = function (widgetId) {
        var widgets = new linqts_1.List(this.catalog);
        var widget = this.getWidget(widgetId);
        if (!widget) {
            throw new Error("could not find widget with id ".concat(widgetId, " "));
        }
        switch (widget.key) {
    ...
    WidgetCatalogService.prototype.getComponentEditor = function (widgetId) {
        var widgets = new linqts_1.List(this.catalog);
        var widget = this.getWidget(widgetId);
        if (!widget) {
            throw new Error("could not find widget with id ".concat(widgetId, " "));
    ...
    WidgetCatalogService.prototype.getWidgetCatalog = function () {
        return this.catalog;
    };
