...
export declare class SurveyService {
    ...
    protected _currentSurvey$: ReplaySubject<Planner.Survey>;
    protected _allSurveys$: ReplaySubject<Planner.SurveySummary[]>;
    protected _currentQuestion$: ReplaySubject<Planner.SurveyQuestion>;
