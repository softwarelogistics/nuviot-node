import {ActivatedRoute, HttpClient, NativeStorageService, Router} from '../core/utils'
...
let usr = new UserService(http, client,  new ErrorReporterService(), new NativeStorageService(), new Router(), new ActivatedRoute())
